...
API Gateway to invoke your cloud function, and the second allows Cloud Functions
to read and write to Secret Manager.
...
Create an API key to use for making queries to your API:
