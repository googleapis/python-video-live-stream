...
def test_create_event_rest(request_type):
    ...
    request_init["event"] = {'name': 'name_value', 'create_time': {'seconds': 751, 'nanos': 543}, 'update_time': {}, 'labels': {}, 'input_switch': {'input_key': 'input_key_value'}, 'ad_break': {'duration': {'seconds': 751, 'nanos': 543}}, 'return_to_program': {}, 'mute': {'duration': {}}, 'unmute': {}, 'execute_now': True, 'execution_time': {}, 'state': 1, 'error': {'code': 411, 'message': 'message_value', 'details': [{'type_url': 'type.googleapis.com/google.protobuf.Duration', 'value': b'\x08\x0c\x10\xdb\x07'}]}}
    request = request_type(**request_init)
